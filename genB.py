...
print('def testB(cost1, ccost, dcost, ecost, rAB, rAC, rAD, rAE, rBC, rBD, rBE, rCD, rCE, rDE, rA, rB, rC, rD, rE):')
print('    ret=[]')
print('')
for x in templist:
    if letter in x:
...
for lvl1 in itertools.combinations(costs1, 1):
    ...
    print('        tail=testC(ccost, dcost, ecost, rAB, rAC, rAD, rAE, rBC, rBD, rBE, rCD, rCE, rDE, rA, rB, rC, rD, rE)'.replace(lvl1, lvl1+'-cost1'), sep='')
    print('        for x in tail:')
    ...
    for lvl2 in itertools.combinations(costs2, 1):
        ...
        print('            tail=testC(ccost, dcost, ecost, rAB, rAC, rAD, rAE, rBC, rBD, rBE, rCD, rCE, rDE, rA, rB, rC, rD, rE)'.replace(lvl2, lvl2+'-cost2').replace('r'+lvl1, '  0'), sep='')
        print('            for x in tail:')
        ...
        for lvl3 in itertools.combinations(costs3, 1):
            ...
            print('                tail=testC(ccost, dcost, ecost, rAB, rAC, rAD, rAE, rBC, rBD, rBE, rCD, rCE, rDE, rA, rB, rC, rD, rE)'.replace(lvl3, lvl3+'-cost3').replace('r'+lvl2, '  0').replace('r'+lvl1, '  0'), sep='')
            print('                for x in tail:')
            print("                    myinsert(x, '",lvl1,"', r",lvl1,")", sep='')
...
#                    #print('t AC BC CD CE')
                print('                    tail=testC(ccost, dcost, ecost, rAB, rAC, rAD, rAE, rBC, rBD, rBE, rCD, rCE, rDE, rA, rB, rC, rD, rE)'.replace(lvl4, lvl4+'-cost4').replace('r'+lvl3, '  0').replace('r'+lvl2, '  0').replace('r'+lvl1, '  0'), sep='')
                print('                    for x in tail:')
                print("                        myinsert(x, '",lvl1,"', r",lvl1,")", sep='')
                print("                        myinsert(x, '",lvl2,"', r",lvl2,")", sep='')
                ...
                print('                        tail=testC(ccost, dcost, ecost, rAB, rAC, rAD, rAE, rBC, rBD, rBE, rCD, rCE, rDE, rA, rB, rC, rD, rE,)'.replace('r'+letter+',', 'r'+letter+'-cost5,').replace('r'+lvl4, '  0').replace('r'+lvl3, '  0').replace('r'+lvl2, '  0').replace('r'+lvl1, '  0'), sep='')
                print('                        for x in tail:')
                print("                            myinsert(x, '",lvl1,"', r",lvl1,")", sep='')
                print("                            myinsert(x, '",lvl2,"', r",lvl2,")", sep='')
                print("                            myinsert(x, '",lvl3,"', r",lvl3,")", sep='')
